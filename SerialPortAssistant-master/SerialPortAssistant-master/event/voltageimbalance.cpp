    ...
    ui(new Ui::voltageimbalance)
{
    ...
    QStringList strList;
    strList<<"上1次电压不平衡记录"<<"上2次电压不平衡记录"<<"上3次电压不平衡记录"<<"上4次电压不平衡记录"<<"上5次电压不平衡记录"<<"上6次电压不平衡记录"<<"上7次电压不平衡记录"<<"上8次电压不平衡记录"<<"上9次电压不平衡记录"<<"上10次电压不平衡记录";
...
void voltageimbalance::on_query_button_clicked()
{
    //初始的4个数据标识
    int va0 = 0x01,va1 = 0x00 ,va2 = 0x09,va3 = 0x03;
    //处理后的4个数据标识
...
//查询码组装函数
QString voltageimbalance::get_Check_code(QString DI3,QString DI2,QString DI1,QString DI0)
{
    //将发送过来的数据标识转换为16进制整型
